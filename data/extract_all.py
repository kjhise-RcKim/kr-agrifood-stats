...
def agri_output():
    ...
    return s
add(id="agri_output_value", name="농림업 생산액", group="농업 한눈에", unit="십억원",
...
add(id="cultivated_area", name="경지면적", group="농업 한눈에", unit="천ha", frequency="연간",
...
add(id="farm_households", name="농가 호수", group="농업 한눈에", unit="천호", frequency="연간",
...
add(id="farm_population", name="농가 인구", group="농업 한눈에", unit="천명", frequency="연간",
...
add(id="agri_gdp_share", name="농림어업 GDP 비중", group="농업 한눈에", unit="%", frequency="연간",
...
add(id="farm_income", name="농가소득(호당)", group="농업 한눈에", unit="천원", frequency="연간",
